...
def demo_seeded_world_generation():
    ...
    print(f"   World A and B are identical: {world_a.data.tile_data == world_b.data.tile_data}")
    print(f"   World A and C are different: {world_a.data.tile_data != world_c.data.tile_data}")
    print()
    ...
    print(f"   Game 1 and 2 have identical worlds: {game1.world.data.tile_data == game2.world.data.tile_data}")
    print(f"   Game 1 and 3 have different worlds: {game1.world.data.tile_data != game3.world.data.tile_data}")
    print()
...
def demo_world_comparison():
    ...
    for i, seed1 in enumerate(seeds):
        for seed2 in seeds[i+1:]:
            ...
            print(f"  Seed {seed1} vs Seed {seed2}: {'Identical' if are_identical else 'Different'}")
