...
class Body:
    ...
    def get_total_walk_speed_modifier(self) -> float:
        ...
        total = 0.0
        leg_parts = [
            self.parts.get(BodyPartType.LEFT_LEG),
            self.parts.get(BodyPartType.RIGHT_LEG),
        ]
    ...
    def get_total_break_speed_modifier(self) -> float:
        ...
        total = 0.0
        arm_parts = [
            self.parts.get(BodyPartType.LEFT_ARM),
            self.parts.get(BodyPartType.RIGHT_ARM),
        ]
    ...
    def get_action_speed(self, action_type: str) -> float:
        ...
        elif action_type in ["mine", "break"] or action_type == "craft" or action_type == "push":
