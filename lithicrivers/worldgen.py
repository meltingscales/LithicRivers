...
from lithicrivers.game import Tile, Tiles, weighted_choice
...
class SeededWorldGenerator:
    ...
    def seeded_weighted_choice(self, weights: List[float], choices: List[Any], context: str = "") -> Any:
        """
...
def generate_world_with_seed(radius: VectorN, seed: Optional[int] = None) -> Dict[str, Tile]:
    """
