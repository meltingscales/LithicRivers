...
class SaveMetadata:
    ...
    def __init__(self, filename: str, timestamp: float, game_tick: int, player_name: str, world_seed: int):
        self.filename = filename
        self.timestamp = timestamp
        self.game_tick = game_tick
        self.player_name = player_name
        self.world_seed = world_seed
        self.readable_time = datetime.fromtimestamp(timestamp).strftime("%Y-%m-%d %H:%M:%S")
...
class GameSaveManager:
    ...
    def save_game(self, game: 'Game', save_name: Optional[str] = None, is_snapshot: bool = False) -> bool:
        """
        Save a game to disk.
