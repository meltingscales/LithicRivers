...
class ConfigManager:
    ...
    def _load_json_file(self, file_path: Path, default_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logging.warning(f"Error loading config file {file_path}: {e}. Using defaults.")
            return default_data
    ...
    def get_vector_setting(self, category: str, key: str, environment: str = "production") -> VectorN:
