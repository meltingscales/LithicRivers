...
class ProceduralStructureGenerator:
    ...
    def generate_dungeon(
        ...
        logger.info(f"Generated {dungeon_type.value} at {base_position} with {tiles_placed} tiles")
    ...
    def _place_dungeon_in_world(
        ...
        for rel_pos, symbol in layout.items():
            ...
            abs_x = base_position.x + rel_pos.x if base_position.x is not None else rel_pos.x
            abs_y = base_position.y + rel_pos.y if base_position.y is not None else rel_pos.y
            abs_z = base_position.z + rel_pos.z if base_position.z is not None else rel_pos.z
