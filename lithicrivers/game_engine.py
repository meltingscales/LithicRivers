...
class GameState:
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            self.player_health == other.player_health and
            self.player_stamina == other.player_stamina and
            self.viewport == other.viewport and
            self.world_data == other.world_data and
...
class GameEngine:
    ...
    def render_viewport(self, viewport: Optional[Viewport] = None) -> RenderedData:
        ...
        return RenderedData(
            render_data=[[generate_sprite_repeat('?', 1)]],
            scale=1
        )
...
from lithicrivers.game import Tile, Item 