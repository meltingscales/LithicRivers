...
class TestConfigMerge(OptimizedTestCase):
    ...
    def test_config_save_and_load(self):
        ...
        self.assertEqual(
            config_manager.get_keybind("action", "PICKUP_ITEMS"), frozenset(["h"])
        )
        self.assertEqual(
            config_manager.get_setting("game", "DEFAULT_PLAYER_NAME"), "Test Player"
        )
        ...
        self.assertEqual(
            saved_config["settings"]["game"]["DEFAULT_PLAYER_NAME"], "Test Player"
        )
    ...
    def test_backward_compatibility(self):
        ...
        self.assertEqual(
            config_manager.get_setting("game", "GAME_NAME"), "LithicRivers"
        )

        # Test vector settings
        viewport_radius = config_manager.get_vector_setting(
            "viewport", "VIEWPORT_RADIUS"
        )
