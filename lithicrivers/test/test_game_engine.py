...
from lithicrivers.game import Items, Tiles
...
class TestGameState(unittest.TestCase):
    ...
    def test_game_state_copy(self):
        ...
        original_state = GameState(
            player_position=VectorN(1, 2, 3), player_health=50, player_stamina=75
        )
...
class TestGameEngine(OptimizedTestCase):
    ...
    def test_move_player(self):
        ...
        self.assertEqual(
            new_state.player_position, initial_position + VEC_NORTH + VEC_EAST
        )
    ...
    def test_save_and_load_state(self):
        ...
        try:
            ...
            self.assertEqual(
                self.engine.state.player_position, new_engine.state.player_position
            )
