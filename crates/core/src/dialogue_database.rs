        ...
        tree.add_node(DialogueNode {
            ...
            choices: vec![
                ...
                DialogueChoice {
                    ...
                    unlocks_quest: None,
                    requires_quest_active: Some(QuestType::RepairBrokenAndroid),
                    requires_quest_complete: None,
                },
            ],
            auto_continue: false,
